...
# STID ,D2STGNN ,MTGNN ,StemGNN ,GTS ,DGCRN ,Linear, DLinear, NLinear,Autoformer ,HINetwork ,FEDformer,Informer, InformerStack,Pyraformer
# GraphWaveNet , DCRNN , STGCN ,*STNorm ,AGCRN
