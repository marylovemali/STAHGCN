...
class SimpleTimeSeriesForecastingRunner(BaseTimeSeriesForecastingRunner):
    ...
    def forward(self, data: tuple, epoch: int = None, iter_num: int = None, train: bool = True, **kwargs) -> tuple:
        ...
        # preprocess
        # print("--------------xxxxx----data--------------------",len(data))
        # print("--------------xxxxx----data0--------------------", data[0].shape)
        # print("--------------xxxxx----data1--------------------", data[1].shape)
        # print("--------------xxxxx----data2--------------------", data[2].shape)
        # future_data, history_data = data       原件20240705
