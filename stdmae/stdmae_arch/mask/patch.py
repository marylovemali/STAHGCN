...
class PatchEmbedding(nn.Module):
    ...
    def __init__(self, patch_size, in_channel, embed_dim, norm_layer):
        ...
        print("-----------self.norm_layer---------",self.norm_layer)
